// ============================================================
// VOXIS — app.js
// Inicialização geral e funções globais da interface
// ============================================================

const App = {

    init() {
        console.log('◈ VOXIS v1.0 iniciando...');
        Memory.init();
        Brain.init();
        VoiceEngine.init();
        SupabaseDB.init();
...
function handleImport(event) {
    ...
    reader.onload = (e) => {
        ...
        App.addMessage('user', `📄 Arquivo importado: ${file.name}`);
